...
const RAL_LIST: RalColor[] = [
  ...
  //Tinte EKIPAZH
    { code: 'Forest Green', name: 'Fores Green', hex: '#013e21' },
    { code: 'Turner Oak toffee', name: 'Turner Oak toffee', hex: '#6e5945' },
    { code: 'Turner Oak', name: 'Turner Oak', hex: '#a28a67' },
    { code: 'Shiffield Oak', name: 'Shiffield Oak', hex: '#cbaa8a' },
    { code: 'Shiffield Oak Concrete', name: 'Shiffield Oak Concrete', hex: '#868887' },
    { code: 'Shiffield Oak Alpine', name: 'Shiffield Oak Alpine', hex: '#bcb9b0' },
    { code: 'Shiffield Oak Brown', name: 'Shiffield Oak Brown', hex: '#716454' },  
    { code: 'Black Matte', name: 'Black Matte', hex: '#000000' },
    { code: 'Turner Oak', name: 'Turner Oak', hex: '#a28a67' },
    { code: 'Pearl White', name: 'Pearl White', hex: '#f9f1e6' },
    { code: 'White Matte', name: 'White Matte', hex: '#fbfbfb' },
    { code: 'Autumn red', name: 'Autumn red', hex: '#63160e' },
    { code: 'Dark cherry', name: 'Dark cherry', hex: '#1b0200' },
    { code: 'Mahogany', name: 'Mahogany', hex: '#211501' },
    { code: 'Chocolate Brown', name: 'Chocolate Brown', hex: '#1c0201' },
    { code: 'Montana oak', name: 'Montana oak', hex: '#271d0d' },
    { code: 'Birch tree', name: 'Birch tree', hex: '#5d4d3e' },
    { code: 'Noce Walnut', name: 'Noce Walnut', hex: '#5b3316' },
    { code: 'Golden Oak', name: 'Golden Oak', hex: '#72370a' },
    { code: 'Light Oak', name: 'Light Oak', hex: '#705028' },
    { code: 'Natural Oak', name: 'Natural Oak', hex: '#c98e5c' },
    { code: 'Pine Tree ', name: 'Pine Tree ', hex: '#b78c0b' },
    { code: 'AnTEAK ', name: 'AnTEAK ', hex: '#b78c0b' },
    { code: 'Antracite', name: 'Antracite', hex: '#30332f' },
    { code: 'Slate grey', name: 'Slate grey', hex: '#2b3035' },
    { code: 'Ficus', name: 'Ficus', hex: '#4d493c' },
    { code: 'Quartz', name: 'Quartz', hex: '#3c392c' },
    { code: 'Titan', name: 'Titan', hex: '#514c45' },
    { code: 'Besalt grey', name: 'Besalt grey', hex: '#605656' },
    { code: 'Cloudy grey', name: 'Cloudy grey', hex: '#6d887f' },
    { code: 'Silver metallic', name: 'Silver metallic', hex: '#9999a9' },
    { code: 'Besalt grey', name: 'Besalt grey', hex: '#5f5856' },
    { code: 'Scandinavian Gray', name: 'Scandinavian Gray', hex: '#605b55' },
]
