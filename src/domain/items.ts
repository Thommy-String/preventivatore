  ...
  switch (kind) {
    case 'finestra':
      return {
        ...
        color: null, glass: null, hinges_color: null, uw: null, custom_fields: []
      }
    case 'portafinestra':
      return {
        id: crypto.randomUUID(),
    ...
    case 'cassonetto':
      return {
        ...
        motore: 'manuale', colore: null, custom_fields: []
      }
    case 'zanzariera':
      return {
        id: crypto.randomUUID(),
        ...
        scorrimento: 'verticale', rete: 'fibra', colore: null, custom_fields: []
      }
    case 'custom':
      return { id: crypto.randomUUID(), kind, title: 'Voce personalizzata', price_mode: 'total', price_total: 0, custom_fields: [] }
    case 'persiana':
    case 'tapparella':
      return { id: crypto.randomUUID(), kind, width_mm: 1000, height_mm: 1500, qty: 1, price_mode: 'per_mq', price_per_mq: 180, custom_fields: [] }
  }
}